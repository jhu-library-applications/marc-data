...
f=csv.writer(open('personalNamesUnique.csv', 'wb'))
f.writerow(['value'])
...
f=csv.writer(open('corporateNamesUnique.csv', 'wb'))
f.writerow(['value'])
...
f=csv.writer(open('miscNamesUnique.csv', 'wb'))
f.writerow(['value'])
...
f=csv.writer(open('subjectsUnique.csv', 'wb'))
f.writerow(['value'])
